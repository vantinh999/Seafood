...
<body class="home page-template-default page page-id-2 woocommerce-no-js">
    ...
    <div id="wrapper" class="hasbg">
                    ...
                    <div class="page_content_wrapper">
                        <div class="inner">
                            ...
                            <div style="font-size:30px;text-transform:uppercase;letter-spacing:-1px;font-weight:300;">
                                <h2 class="ppb_title"><span class="ppb_title_first"><u>VT</u></span></h2>
                            </div>
        ...
        <div class="one withsmallpadding ppb_text" style="padding-top: 0 !important;text-align:center;padding:50px 0 50px 0;">
            <div class="standard_wrapper">
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div style="margin:auto;width:80%">
<p>Vui lòng điền đầy đủ thông tin nếu muốn liên hệ với chúng tôi</p>                        </div>
     
                    </div>
                </div>
            </div>
        </div>
        <div class="one" style="padding-bottom: 100px !important;position:relative;padding:30px 0 30px 0;">
            <div class="standard_wrapper">
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div class="one_half parallax_scroll_image" style="width:70%;">
                            <div class="image_classic_frame expand">
                                <div class="image_wrapper">
                                    <a href="upload/background_lienhe.jpg" class="img_frame"><img src="upload/background_lienhe.jpg" class="portfolio_img" alt="" /></a>
                                </div>
                            </div>
                        </div>
                        <div class="one_half last parallax_scroll" style="width:40%;position:absolute;right:90px;background:#ffffff;padding:30px;" data-stellar-ratio="1.3">
                            <h2>Gửi ý kiến phản hồi</h2>
                            <strong>(*Chúng tôi sẽ không phản hồi nếu như thông tin của bạn không chính xác)</strong>
                            <div id="reponse_msg_1570105835359928382" class="contact_form_response">
                                <ul></ul>
                            </div>
                                ...
                                <div class="quform-elements">
                                    <div class="quform-element">
                                            ...
                                            <span class="wpcf7-form-control-wrap your-name">
                                                <input id="name" type="text" name="name" size="40" class="input1" aria-required="true" aria-invalid="false" placeholder="Họ tên*">
                                            </span> 
                                    ...
                                    <div class="quform-element">
                                            ...
                                            <span class="wpcf7-form-control-wrap your-message">
                                                <textarea  id="message" name="message" cols="40" rows="10" class="input1" aria-invalid="false" placeholder="Nội dung*"></textarea>
                                            </span>
                                    ...
                                    <div class="quform-submit">
                                        <div class="quform-submit-inner">
                                            <button type="submit" name="sub_guiphanhoi" class="submit-button"><span>Gửi phản hồi</span></button>
                                        </div>
                           ...
                           <?php
                           include('db.php');
                           if(isset($_POST["sub_guiphanhoi"])==true){
                            ...
                            $sql = "INSERT INTO contact (fullname, email, content)
                            VALUES ('".$_POST["name"]."','".$_POST["email"]."','".$_POST["message"]."')";
                            if (mysqli_query($conn, $sql)) {
                                echo '<br> <div class="alert alert-success">
                                    <strong>Success!</strong>Cảm ơn bạn đã gửi ý kiến phản hồi cho chúng tôi
                                  </div>';
                            } else {
                                echo '<br> <div class="alert alert-danger" role="alert">
