                    ...
                    <div class="page_content_wrapper">
                        <div class="inner">
                            ...
                            <div style="font-size:30px;text-transform:uppercase;letter-spacing:-1px;font-weight:300;">
                                <h2 class="ppb_title"><span class="ppb_title_first">Các món</span></h2> <h2><strong>đANG giảm giá</strong></h2>
                            </div>
                ...
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div class="one_half parallax_scroll" style="width:40%;position:absolute;left:90px;background:#ffffff;padding:40px;z-index:2;" data-stellar-ratio="1.3">
                            <h2 class="ppb_menu_title">Danh sách</h2>
                            <div id="menu_3197" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title" style="background:#ffffff;">Cua xào me</span>
                                <span class="menu_dots"></span>
                                <span class="menu_price" style="background:#ffffff;">Chỉ còn 150.000 VNĐ</span></h5>
                            ...
                            <div id="menu_3172" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title" style="background:#ffffff;">Combo lẩu hải sản</span>
                                <span class="menu_dots"></span>
                                <span class="menu_price" style="background:#ffffff;">Chỉ còn 400.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                            ...
                            <div id="menu_3173" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title" style="background:#ffffff;">Cá đuối nướng</span>
                                <span class="menu_dots"></span>
                                <span class="menu_price" style="background:#ffffff;">Chỉ còn 200.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                            ...
                            <div id="menu_3174" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title" style="background:#ffffff;">Gõi tôm</span>
                                <span class="menu_dots"></span>
                                <span class="menu_price" style="background:#ffffff;">Chỉ còn 150.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                            ...
                            <div id="menu_3175" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title" style="background:#ffffff;">Cua chiên mắm</span>
                                <span class="menu_dots"></span>
                                <span class="menu_price" style="background:#ffffff;">Chỉ còn 150.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                </div>
                        ...
                        <div class="one_half parallax_scroll_image last" style="width:65%;">
                            <div class="image_classic_frame expand">
                                <div class="image_wrapper">
                                    <a href="upload/1440876.jpg" class="img_frame"><img src="upload/1440876.jpg" class="portfolio_img" alt=""/></a>
                                </div>
                            </div>
                        </div>
                        <br class="clear"/>
