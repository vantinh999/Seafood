...
<head>
    ...
    <title>Video nhà hàng hải sản VT</title>
...
<body class="home page-template-default page page-id-2 woocommerce-no-js">
    ...
    <div id="wrapper" class="hasbg">
                    ...
                    <div class="page_content_wrapper">
                        <div class="inner">
                            ...
                            <div style="font-size:30px;text-transform:uppercase;letter-spacing:-1px;font-weight:300;">
                                <h2 class="ppb_title"><span class="ppb_title_first">Video</span></h2> <h2><strong><u>Nhà hàng</u></strong></h2>
                            </div>
       ...
       <center> <video width="900" height="500" controls>
        <source src="upload/video_nhahang.mp4" type="video/mp4">
