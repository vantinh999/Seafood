...
<body class="home page-template-default page page-id-2 woocommerce-no-js">
    ...
    <div id="wrapper" class="hasbg">
                    ...
                    <div class="page_content_wrapper">
                        <div class="inner">
                            ...
                            <div style="font-size:30px;text-transform:uppercase;letter-spacing:-1px;font-weight:300;">
                                <h2 class="ppb_title"><span class="ppb_title_first">menu</span></h2> <h2><strong>Chúc quý khách ngon miệng</strong></h2>
                            </div>
        ...
        <div class="parallax title" data-image="upload/1440960.jpg" data-width="1440" data-height="960" data-content-height="60">
            <div class="parallax_title">
                <h2 class="ppb_title"><span class="ppb_title_first">DANH SÁCH</span>MÓN khai vị</h2>
            </div>
        </div>
                            ...
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Imported Salmon Steak" href="upload/kv1.jpg" class="fancy-gallery" title="Keralan Fish Curry - Nigella Lawson from Nigella Summer Shot for Observer Food Monthly Food Styling - Emily Jonzon Prop styling - Tamzin Ferdinando"><i class="fa fa-search"></i></a>
                                    </div>
                                </div>
                            </div>
                            <img src="upload/kv1.jpg" alt=""/>
                        </div>
                        <br class="clear"/>
                        <div id="portfolio_desc_3196" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3196" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Súp bào ngư</span>
                                <span class="menu_dots"></span><span class="menu_price">100.000 VNĐ</span></h5>
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated1">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Imported Salmon Steak" href="upload/kv2.jpg" class="fancy-gallery" title="Keralan Fish Curry - Nigella Lawson from Nigella Summer Shot for Observer Food Monthly Food Styling - Emily Jonzon Prop styling - Tamzin Ferdinando"><i class="fa fa-search"></i></a>
                                    </div>
                                </div>
                            </div>
                            <img src="upload/kv2.jpg" alt=""/>
                        </div>
                        <br class="clear"/>
                        <div id="portfolio_desc_3196" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3196" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Nộm mực chua cay</span>
                                <span class="menu_dots"></span><span class="menu_price">100.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Nộm mực chua cay
                                </div>
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated3">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Italian Source Mushroom" href="upload/kv3.jpg" class="fancy-gallery" title=""><i class="fa fa-search"></i></a><a href="#"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                            <img src="upload/kv3.jpg" alt=""/>
                        </div>
                        <br class="clear"/>
                        <div id="portfolio_desc_3190" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3190" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Nem hải sản</span>
                                <span class="menu_dots"></span><span class="menu_price">50.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Nem hải sản
                                </div>
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated4">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Fried Potatoes With Garlic" href="upload/kv4.jpg" class="fancy-gallery" title=""><i class="fa fa-search"></i></a><a href="#"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                            <img src="upload/kv4.jpg" alt=""/>
                        </div>
                        <br class="clear"/>
                        <div id="portfolio_desc_3191" class="portfolio_desc portfolio4 filterable last">
                            <div id="menu_3191" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Súp hải sản rong biển	
                                </span>
                                <span class="menu_dots"></span><span class="menu_price">100.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Súp hải sản rong biển
                                </div>
                                <div class="menu_order">
                                    <a href="#">Đặt</a>
                                </div>
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated5">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Tuna Roast Source" href="upload/kv5.jpg" class="fancy-gallery" title=""><i class="fa fa-search"></i></a><a href="#"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                            <img src="upload/kv5.jpg" alt=""/>
                        </div>
                        <br class="clear"/>
                        <div id="portfolio_desc_3192" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3192" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Nộm sứa tam vị</span>
                                <span class="menu_dots"></span><span class="menu_price">100.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Nộm sứa tam vị
                                </div>
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated6">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Roast Pork (4 Sticks)" href="upload/kv6.jpg" class="fancy-gallery" title=""><i class="fa fa-search"></i></a><a href="#"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                            <img src="upload/kv6.jpg" alt=""/>
                        </div>
                        <br class="clear"/>
                        <div id="portfolio_desc_3193" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3193" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Súp cá bớp lá lốt</span>
                                <span class="menu_dots"></span><span class="menu_price">120.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Súp cá bớp lá lốt
                                </div>
                                <div class="menu_order">
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated7">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Salted Fried Chicken" href="upload/kv7.jpg" class="fancy-gallery" title=""><i class="fa fa-search"></i></a><a href="#"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                            <img src="upload/kv7.jpg" alt=""/>
                        </div>
                        <br class="clear"/>
                        <div id="portfolio_desc_3194" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3194" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Súp Ngán</span>
                                <span class="menu_dots"></span><span class="menu_price">110.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Súp Ngán
                                </div>
                                <div class="menu_order">
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated8">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Crab With Curry Sources" href="upload/kv8.jpg" class="fancy-gallery" title="Signature Dish"><i class="fa fa-search"></i></a><a href="#"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                            <img src="upload/kv8.jpg" alt=""/>
                        </div>
                        <br class="clear"/>
                        <div id="portfolio_desc_3195" class="portfolio_desc portfolio4 filterable last">
                            <div id="menu_3195" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Salad cà chua dưa chuột	
                                </span>
                                <span class="menu_dots"></span><span class="menu_price">50.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
        ...
        <div class="parallax title" data-image="upload/1440960.jpg" data-width="1440" data-height="960" data-content-height="60">
            <div class="parallax_title">
                <h2 class="ppb_title"><span class="ppb_title_first">DANH SÁCH</span>MÓN HẢI SẢN</h2>
            </div>
        </div>
        <div class="ppb_portfolio one nopadding " style="padding:0px 0 0px 0;">
            <div class="page_content_wrapper fullwidth">
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated1">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Imported Salmon Steak" href="upload/2 (2).jpg" class="fancy-gallery" title="Keralan Fish Curry - Nigella Lawson from Nigella Summer Shot for Observer Food Monthly Food Styling - Emily Jonzon Prop styling - Tamzin Ferdinando"><i class="fa fa-search"></i></a>
                                    </div>
                                </div>
                            </div>
                            <img src="upload/2 (2).jpg" alt=""/>
                        </div>
                        <br class="clear"/>
                        <div id="portfolio_desc_3196" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3196" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Combo cua hầm xả</span>
                                <span class="menu_dots"></span><span class="menu_price">400.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Combo cua hầm xả
                                </div>
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated1">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Imported Salmon Steak" href="upload/4 (2).jpg" class="fancy-gallery" title="Keralan Fish Curry - Nigella Lawson from Nigella Summer Shot for Observer Food Monthly Food Styling - Emily Jonzon Prop styling - Tamzin Ferdinando"><i class="fa fa-search"></i></a>
                                    </div>
                                </div>
                            </div>
                            <img src="upload/4 (2).jpg" alt=""/>
                        </div>
                        <br class="clear"/>
                        <div id="portfolio_desc_3196" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3196" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Cá um</span>
                                <span class="menu_dots"></span><span class="menu_price">250.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Cá um
                                </div>
                            </div>
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated3">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Italian Source Mushroom" href="upload/5 (2).jpg" class="fancy-gallery" title=""><i class="fa fa-search"></i></a><a href="#"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                            <img src="upload/5 (2).jpg" alt=""/>
                        </div>
                        <br class="clear"/>
                        <div id="portfolio_desc_3190" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3190" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Sốt nghêu</span>
                                <span class="menu_dots"></span><span class="menu_price">200.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Sốt nghêu
                                </div>
                                <div class="menu_order">
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated4">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Fried Potatoes With Garlic" href="upload/7 (2).jpg" class="fancy-gallery" title=""><i class="fa fa-search"></i></a><a href="#"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                            <img src="upload/7 (2).jpg" alt=""/>
                        </div>
                        <br class="clear"/>
                        <div id="portfolio_desc_3191" class="portfolio_desc portfolio4 filterable last">
                            <div id="menu_3191" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">gõi sứa</span>
                                <span class="menu_dots"></span><span class="menu_price">100.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Gõi sứa
                                </div>
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated5">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Tuna Roast Source" href="upload/8.jpg" class="fancy-gallery" title=""><i class="fa fa-search"></i></a><a href="#"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="portfolio_desc_3192" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3192" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Sốt tôm cay</span>
                                <span class="menu_dots"></span><span class="menu_price">100.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Sốt tôm cay
                                </div>
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated6">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Roast Pork (4 Sticks)" href="upload/9.jpg" class="fancy-gallery" title=""><i class="fa fa-search"></i></a><a href="#"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="portfolio_desc_3193" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3193" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Tôm nướng</span>
                                <span class="menu_dots"></span><span class="menu_price">200.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Tôm nướng
                                </div>
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated7">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Salted Fried Chicken" href="upload/11.jpg" class="fancy-gallery" title=""><i class="fa fa-search"></i></a><a href="#"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="portfolio_desc_3194" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3194" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Tôm tít xào</span>
                                <span class="menu_dots"></span><span class="menu_price">150.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Tôm tít xào
                                </div>
                                <div class="menu_order">
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated8">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content">
                                        <a data-title="Crab With Curry Sources" href="upload/14.jpg" class="fancy-gallery" title="Signature Dish"><i class="fa fa-search"></i></a><a href="#"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="portfolio_desc_3195" class="portfolio_desc portfolio4 filterable last">
                            <div id="menu_3195" class="menu_content_classic">
                                <h5 class="menu_post">
                                <span class="menu_title">Nghêu hấp</span>
                                <span class="menu_dots"></span><span class="menu_price">100.000 VNĐ</span></h5>
                                <div class="post_detail menu_excerpt">
                                    #Nghêu hấp
                                </div>
        ...
        <div class="parallax title" data-image="upload/1200800.jpg" data-width="1200" data-height="800" data-content-height="60">
            <div class="parallax_title">
                <h2 class="ppb_title"><span class="ppb_title_first">Luxury</span></h2>
            </div>
        </div>
        <div class="divider one">
            &nbsp;
        ...
        <div class="one ppb_card_two_cols_with_image" style="padding: 70px 0 70px 0 !important;position:relative;padding:40px 0 40px 0;">
            <div class="standard_wrapper">
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div class="one_half parallax_scroll_image" style="width:65%;">
                            <div class="image_classic_frame expand">
                                <div class="image_wrapper">
                                    <a href="upload/1440958.jpg" class="img_frame"><img src="upload/1440958.jpg" class="portfolio_img" alt=""/></a>
                                </div>
                            </div>
                        </div>
                        <div class="one_half last parallax_scroll" style="width:40%;position:absolute;right:90px;padding:40px;background:#ffffff;" data-stellar-ratio="1.3">
                            <h2>Mở cửa từ 8 giờ sáng đến 12 giờ đêm.</h2>
                            <div class="ppb_subtitle">
                                SỰ HÀI LÒNG CỦA CÁC BẠN LÀ ĐỘNG LỰC ĐỂ CHÚNG TÔI CỐ GẮNG HOÀN THIỆN VÀ PHỤC VỤ TỐT HƠN.
                            </div>
